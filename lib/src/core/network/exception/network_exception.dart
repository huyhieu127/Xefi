...
import 'package:xefi/src/core/network/exception/network_error_resp.dart';
  ...
  NetworkException.fromDioError(DioException dioException) {
    ...
    switch (dioException.type) {
      ...
      case DioExceptionType.badResponse:
        final model = NetworkErrorResp.fromJson(
            dioException.response?.data as Map<String, dynamic>);
        message = model.status ?? 'Unexpected bad response';
        break;
